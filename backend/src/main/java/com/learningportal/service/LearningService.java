...
/**
 * Service interface for managing learning content (modules, topics, questions,
 * code examples)
 */
public interface LearningService {
    ...
    Page<PracticeQuestion> searchQuestions(QuestionType type, DifficultyLevel difficulty, String searchTerm,
            Pageable pageable);
