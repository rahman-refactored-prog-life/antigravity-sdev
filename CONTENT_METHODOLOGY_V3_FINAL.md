...
✅ **All 7 original layers preserved** (nothing removed!)  
✅ **All 12 Harvard elements integrated** (nothing missed!)  
✅ **Zero redundancy** (smart merging of overlapping concepts)  
✅ **Optimized flow** (logical progression from beginner to expert)  
✅ **Production-ready** (ready to implement for Phase 2)

---

## 🛑 Universal Content Gathering & Formatting Protocol (MANDATORY)

**Status**: **STRICT COMPLIANCE REQUIRED** for ALL Phases, ALL Topics, ALL Domains.

### 1. "Deep Gathering" Strategy (Simulated Web Scrape)
For **EVERY** topic, you must perform a comprehensive aggregation of questions, simulating a deep dive into:
- **Sources**: LeetCode (Company Tags), GeeksforGeeks, InterviewBit, Glassdoor, CareerCup, Blind, Reddit.
- **Volume Target**: **Exhaustive Coverage (No Upper Limit)**.
  - **Tier 1**: Core Patterns (The top 50 must-knows).
  - **Tier 2**: The Vault (Every other known variations, potentially 100+).
- **The "Vault Index" Rule**:
  - If you cannot generate full solutions for all 100 questions in one session, you **MUST** list the remaining questions as an **Index** (Q15, Q16... Q100) with empty checkboxes.
  - **Reason**: This prevents future agents from thinking the topic is "done" just because 15 questions exist. The empty list forces continuity.
- **Categorization**:
  - *Conceptual* (e.g., "Internal workings")
  - *Coding Challenges* (e.g., "Implementation details")
  - *Edge Cases* (e.g., "Tricky outputs")
  - *System Design* (Contextual)

### 2. Mandatory Coding Format
**EVERY** implementation-based question must include:
1.  **Multi-Language Tabs**: Full implementations in **Java**, **Python**, **C++**, **JavaScript**, and **Go**.
2.  **Company Badges**: Explicit `**Companies**: [List]` tags.
3.  **Complexity Analysis**: Time/Space complexity.

> **Note**: This protocol supersedes any previous "sampling" strategies. We aim for **exhaustive** coverage.
...
- ✅ Plain-language definition (Concept Overview #1)
- ✅ Why it matters (Concept Overview #1)
- ✅ Where it fits (Concept Overview #1)
- ✅ Relatable analogy (Motivation & Mental Model #2)
- ✅ Visual mental model (Motivation & Mental Model #2)
- ✅ Common misconceptions (Motivation & Mental Model #2)
...
- [Concept A] → Why: [Reason]
- [Concept B] → Why: [Reason]

**This Concept**: **[Topic Name]** ← You are here

**Next Steps** (Learn these after):
- [Concept C] → Builds on: [How]
- [Concept D] → Builds on: [How]

**Visual Dependency Map**:
```
[Prerequisite A] ──┐
                   ├──> [THIS TOPIC] ──┐
[Prerequisite B] ──┘                   ├──> [Next Topic A]
                                       └──> [Next Topic B]
```
...
❌ **Misconception 1**: [What beginners think]
✅ **Reality**: [What's actually true]
💡 **Why this confusion**: [Explanation]

❌ **Misconception 2**: [What beginners think]
✅ **Reality**: [What's actually true]
💡 **Why this confusion**: [Explanation]
...
**Harvard Elements Integrated**:
- ✅ Plain-language definition (already in Layer 1, reinforced here)
- ✅ Multiple analogies for different learning styles
- ✅ Deep, comprehensive definition (NEW!)
...
OPERATIONS:
  - Operation 1: [Signature] → [Return type]
    Precondition: [What must be true]
    Postcondition: [What will be true]
    Complexity: [Time/Space]
  
  - Operation 2: [Signature] → [Return type]
    [Similar structure...]
...
**Harvard Elements Integrated**:
- ✅ Level 0-5 Progressive Learning Path (Harvard #3)
- ✅ Step-by-step breakdown (Harvard #3)
- ✅ Static diagrams (Harvard #4)
- ✅ State transitions (Harvard #4)
- ✅ Animations description (Harvard #4)
...
#### State Transitions
```
Initial State → [Action 1] → State 2 → [Action 2] → Final State
```
...
**Trace**:
```
Step 1: [State] → [Action] → [New State]
Step 2: [State] → [Action] → [New State]
...
Final: [Result]
```
...
**Harvard Elements Integrated**:
- ✅ Multi-language implementations (Harvard #5)
- ✅ Consistent naming conventions (Harvard #5)
- ✅ Unit tests + edge cases (Harvard #5)
- ✅ Complexity annotations (Harvard #5)
- ✅ Interactive widgets (Harvard #4)
...
**Harvard Elements Integrated**:
- ✅ Core exercises (Harvard #7)
- ✅ Edge case drills (Harvard #7)
- ✅ Challenge problems (Harvard #7)
- ✅ Mini-projects (Harvard #7)
- ✅ Auto-graded quizzes (Harvard #7)
...
**Follow-up Questions**:
- Q1: [Question] → A: [Approach]
- Q2: [Question] → A: [Approach]
...
**Harvard Elements Integrated**:
- ✅ Common mistakes (Harvard #9)
- ✅ Why they happen (Harvard #9)
- ✅ How to avoid them (Harvard #9)
...
**Harvard Elements Integrated**:
- ✅ How concept scales (Harvard #11)
- ✅ Trade-offs in distributed systems (Harvard #11)
- ✅ Observability & failure modes (Harvard #11)
...
**Harvard Elements Integrated**:
- ✅ Top FAANG questions (Harvard #8)
- ✅ Hints + step-by-step solutions (Harvard #8)
- ✅ Multi-language answers (Harvard #8)
- ✅ Complexity analysis + pitfalls (Harvard #8)
...
**Harvard Elements Integrated**:
- ✅ Key formulas (Harvard #10)
- ✅ Code snippets (Harvard #10)
- ✅ Invariants (Harvard #10)
- ✅ Complexity tables (Harvard #10)
...
- [ ] Two elements → [Expected behavior]
- [ ] All same → [Expected behavior]
- [ ] Sorted → [Expected behavior]
- [ ] Reverse sorted → [Expected behavior]
- [ ] Duplicates → [Expected behavior]
- [ ] Negative values → [Expected behavior]
- [ ] Zero → [Expected behavior]
- [ ] Max size → [Expected behavior]
...
- ✅ Books (Harvard #12)
- ✅ Papers (Harvard #12)
- ✅ Official docs (Harvard #12)
- ✅ Curated tutorials (Harvard #12)
...
- ✅ Interview-ready content (10+ questions per topic)
...
### Perfect Integration
- ✅ All 7 original layers preserved and enhanced
- ✅ All 12 Harvard elements integrated
- ✅ Zero redundancy (smart merging)
- ✅ Logical flow (beginner → expert)
